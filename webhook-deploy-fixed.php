<?php
// Script de déploiement webhook pour Poppy Music
...
// Définir les variables d'environnement pour www-data
putenv('HOME=/var/www');
putenv('NPM_CONFIG_CACHE=/var/www/.npm');
...
foreach ($commands as $cmd) {
    ...
    if ($return_code !== 0) {
        ...
        log_message("Sortie d'erreur: " . implode("\n", $cmd_output));
        break;
    }
